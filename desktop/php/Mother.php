    ...
    <div class="col-lg-2">
        <div class="bs-sidebar affix">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav fixnav">
                <li class="nav-header">Liste équipements Mother
                ...
                <?php
                foreach (eqLogic::byType('Mother') as $eqLogic) {
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">Nom de l'équipement Mother</label>
                    <div class="col-lg-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="Nom de l'équipement Mother"/>
                    </div>
                </div>
                <div class="form-group">
...
<?php include_file('desktop', 'Mother', 'js', 'Mother'); ?>
